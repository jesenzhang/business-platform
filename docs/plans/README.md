...
- [`archive/2026/PLAN-0009-c-legacy-contract-and-document-migration-rehearsal.md`](archive/2026/PLAN-0009-c-legacy-contract-and-document-migration-rehearsal.md)：`Completed / Rehearsal Closed`，真实 C 项目 120-contract read-only rehearsal、replay、integrity/recovery 和 verification report。
