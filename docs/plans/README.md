...
- [`current/PLAN-0009-c-legacy-contract-and-document-migration-rehearsal.md`](current/PLAN-0009-c-legacy-contract-and-document-migration-rehearsal.md)：`Active / Rehearsal Only`，只做 C 项目 read-only migration rehearsal 设计与隔离验证。
