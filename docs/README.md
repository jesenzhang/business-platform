...
- 已归档：plans/archive/2026/PLAN-0009-c-legacy-contract-and-document-migration-rehearsal.md（Completed / Rehearsal Closed；下一步需另行批准 controlled migration design）
