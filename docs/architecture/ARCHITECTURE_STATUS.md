...
安全架构：已形成 Baseline；production OIDC authn 已实现；PlatformUser/TenantMembership/Role/Permission/ResourceScope/Policy 已在 PLAN-0013 实施分支实现（Accepted Candidate 待定）；Agent Capability 待 PLAN-0006 Revision 1
