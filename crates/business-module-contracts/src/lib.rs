...
pub use manifest::{
    ...
    validate_extension_points_against_catalog, ActionContribution, AgentCapabilityContribution,
    AgentCapabilityId, BusinessModuleId, BusinessModuleManifest, BusinessModuleVersion,
    CapabilityRequirementDescriptor, CapabilityRequirementId, CommandContribution,
    CompatibilityDescriptor, ContractDescriptor, ContributionDescriptor, ContributionId,
    DataClassification, DetailSectionContribution, DetailTabContribution,
